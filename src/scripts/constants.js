...
const DEFAULT_TRAITS = [
  ...
  { name: "Horniness", antonym: "Sexual Indifference", category: "Personality Traits" },
  { name: "Intelligence", antonym: "Stupidity", category: "Personality Traits" },
  { name: "Wisdom", antonym: "Ignorance", category: "Personality Traits" },
  ...
  { name: "Imbalance of Power in {{char}}'s favor", antonym: "Imbalance of Power in {{user}}'s favor", category: "Scenario Traits" },
  ...
  { name: "High Stakes/Physical Danger", antonym: "Safety", category: "Scenario Traits" },
